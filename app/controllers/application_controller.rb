class ApplicationController < ActionController::Base
  ...
  def login!(user)
    ...
    if @current_user.username == "Guest"
      ...
      ActiveRecord::Base.connection.execute("ALTER SEQUENCE decks_id_seq RESTART WITH 5")
      ActiveRecord::Base.connection.execute("ALTER SEQUENCE cards_id_seq RESTART WITH 25")
